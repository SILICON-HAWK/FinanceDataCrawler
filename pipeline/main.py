...
class FinanceDataPipeline:
    ...
    def run_company_extraction(self, max_companies: int = None):
        """
        ...
        for sector_name, company_urls in companies_data.items():
            self.logger.info(f"Processing sector: {sector_name} ({len(company_urls)} companies)")
